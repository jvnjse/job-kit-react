        ...
        <div>
            ...
            <div className='rounded-t-lg'>
                ...
                <div className=' flex justify-evenly flex-wrap text-xs bg-background_grey_color py-[3px]'>
                    ...
                    <div>Package : {job.salary_range_from} - {job.salary_range_to} / month</div>
                    <div>Experience 2 - 4 years</div>
                </div>
                <div className="flex p-5 px-56 max-lg:px-24 max-md:px-12 max-sm:p-7 max-sm:flex-col">
                    <div className=' flex-1'>
                        ...
                        <div className=' text-xs  text-text_black_primary_color'>{job.job_description}</div>
                    ...
                    <div className=' w-1/4 flex flex-col items-start pl-16 max-sm:pl-5'>
                        ...
                        <div className=' text-sm font-semibold mt-5 text-text_black_primary_color'>End Date</div>
                        <div className=' text-xs font-thin ml-3 mt-2 flex gap-2 text-text_black_primary_color'><FontAwesomeIcon icon={faCalendar} className='text-base' />{job.application_deadline}
</div>
